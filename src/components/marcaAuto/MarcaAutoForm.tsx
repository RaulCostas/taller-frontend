...
interface MarcaAutoFormProps {
    initialData?: MarcaAuto | null;
    onSubmit: (marcaAuto: Omit<MarcaAuto, 'id'>) => Promise<void>;
    onCancel: () => void;
}

export const MarcaAutoForm = ({ initialData, onSubmit, onCancel }: MarcaAutoFormProps) => {
    ...
    return (
        <div className="p-6">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
                <div className="mb-4">
                    <label className="block mb-2 font-medium text-gray-700 dark:text-gray-300">Nombre de la Marca:</label>
                    <div className="relative">
                        <Car className="absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-500 dark:text-gray-400" size={18} />
                        <input
                            type="text"
