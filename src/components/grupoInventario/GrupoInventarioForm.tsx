...
interface GrupoInventarioFormProps {
    initialData?: GrupoInventario | null;
    onSubmit: (data: CreateGrupoInventarioData) => Promise<void>;
    onCancel: () => void;
}

export const GrupoInventarioForm = ({ initialData, onSubmit, onCancel }: GrupoInventarioFormProps) => {
        ...
        <div className="p-6">
            <div className="flex items-center justify-between mb-6">
                <h2 className="text-2xl font-bold text-gray-800 dark:text-white flex items-center gap-3">
                    ...
                    {initialData ? 'Editar Grupo de Inventario' : 'Nuevo Grupo de Inventario'}
                </h2>
            </div>
