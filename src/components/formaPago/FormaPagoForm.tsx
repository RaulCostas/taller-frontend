...
interface FormaPagoFormProps {
    initialData?: FormaPago | null;
    onSubmit: (formaPago: Omit<FormaPago, 'id'>) => Promise<void>;
    onCancel: () => void;
}

export const FormaPagoForm = ({ initialData, onSubmit, onCancel }: FormaPagoFormProps) => {
